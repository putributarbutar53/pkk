...
$this->title = 'Berita Kecamatan Yang Sedang Menunggu Persetujuan';
?>
<div class="berita-index">
    ...
    <?= GridView::widget([
        ...
        [
            ...
            'label' => 'Penulis',
            'value' => function($model) {
                $findUser = common\models\User::findOne($model->created_by);
        ...
        //'updated_by',
            ...
            'buttons' => [
                ...
                'accept' => function($url, $model) {
                    return Html::a('<span class="glyphicon glyphicon-ok-circle"></span>', Url::to(['/berita/terima', 'id' => $model->id]), [
                ...
                'reject' => function($url, $model) {
                    return Html::a('<span class="glyphicon glyphicon-remove-circle"></span>', Url::to(['/berita/tolak', 'id' => $model->id]), [
