...
$galeriVideo = \backend\models\GaleriVideo::find()
        ->where(['active' => 10])
        ->all();
$baganMekanisme = backend\models\BaganMekanisme::find()
        ->where(['active' => 10])
        ->one();
?>
...
<section class="page-title centred" style="background-image: url(bagery/assets/images/background/background.jpg);">
    <div class="auto-container">
        <div class="content-box">
            <div>
                <h1>Bagan Mekanisme Gerakan PKK</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="blog-details-content">
                    <div class="inner-box">
                        <div class="text">
                            <?php if ($baganMekanisme == !null) { ?>
                            <center><a href = "javascript:;"><img src = "<?= Yii::getAlias('@web') . '/' . $baganMekanisme->foto ?>" alt = ""></a></center>
                                <?php
                            } else {
                                echo'Data Kosong';
                            }
