...
?>
<!-- blog-post -->
<section class="blog-post centred" style="background-image: url(bagery/assets/images/background/background.jpg);">
    <div class="post-inner">
        <h2><?= $model->nama ?></h2>
        <ul class="post-info clearfix">
            <li><?= date("d M Y", strtotime($model->created_at)) ?></li>
            <li>/</li>
            <li><a href=""><?= $user->username; ?></a></li>
        </ul>
        <h6 style="color: white">Waktu Mulai: <?= date("d M Y", strtotime($model->waktu_mulai)) ?></h6>
        <h6 style="color: white">Waktu Selesai: <?= date("d M Y", strtotime($model->waktu_selesai)) ?></h6>
    </div>
</section>
<!-- blog-post end -->
        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="blog-details-content">
                    <div class="inner-box">
                        <div class="text">
                            <center><a href="javascript:;"><img src="<?= Yii::getAlias('@web') . '/' . $model->foto ?>" alt=""></a></center>
                        </div>
                        <br>
                        <div class="text">
                            <?= $model->deskripsi ?>
