...
/**
 * This is the model class for table "{{%bagan_mekanisme}}".
 *
 * @property int $id
 ...
 * @property int $active
 */
class BaganMekanisme extends \yii\db\ActiveRecord
 {
    ...
    public function rules()
    {
        return [
            ...
            [['foto'], 'file', 'maxSize' => 10000 * 1024, 'tooBig' => 'Limit is 10MB'],
        ];
    }
